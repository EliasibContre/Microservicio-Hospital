...
public enum DisponibilidadMedico {
    ...
    public static DisponibilidadMedico obtenerDisponibilidadMedico(Long codigo){
        for (DisponibilidadMedico d : values()){
            if (Objects.equals(d.codigo, codigo))
                return d;
        }
        throw new RecursoNoEncontradoException("COdigo de disponibilida no valido"+codigo);
    }
}
